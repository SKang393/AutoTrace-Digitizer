...
| Marker center detection | Line-aware revision v1 P3 preregistered | Project-owned Apache-2.0 source and new procedural families only; no Chandler, private article, downloaded weights, or prior-candidate bytes | P1 produced no checkpoint. Ignored P2 checkpoint SHA-256 `d80732ae317faa3a315fec0d2add194091fe5ce4295be3ff1d6faa65af7562fb` and ONNX SHA-256 `25d79f6f207f35180d7482e147a1fb1fc099dcd15ab098f109cfb3242c7ff144` remain unapproved. | P1 failed ONNX export preflight. P2 passed CPU parity at `8.270144462585449e-07` with zero false positives, duplicates, or prohibited hits, but missed four of 63 validation markers. P3 reuses the exact P2 bytes with zero optimizer steps and freezes the most conservative passing selection threshold `0.07`. Neither P1 nor P2 opened the public archive. | Experimental, P3 authorized | P1 and P2 are consumed and cannot rerun. P3 must reproduce all 9 exact selection scenes and CPU parity before the single truth-hidden public evaluation can be authorized. No manifest, store, package, or approval exists. |
