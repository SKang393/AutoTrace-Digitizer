...
| Marker center detection | Candidate-level revision v1 P1 preregistration | Project-owned Apache-2.0 source and procedural graph scenes only; no Chandler, private article, downloaded weight, or prior candidate reuse | No checkpoint or ONNX exists; ignored truth-hidden sealed fixtures only | Before training, 33 train/validation scenes and 16 sealed public scenes were frozen with disjoint renderer and degradation families. Selection manifest SHA-256 `23cc48ceb322e50bc3dd3d054430270eb258e13bc2a24ddb2d3c674db3f7bec7`; fixture archive SHA-256 `99091ce6ec9608c1fc72bba7e8277f452ae9d13c4bfb04bbd259ccbc6c14b0c0`; private manifest SHA-256 `6232d1ab2a50479211ce6888e55a2d51471a870d0b679713dd7570d94091b768` | Preregistered, not executed | The separate three-run budget authorizes only P1. Training may inspect train and validation scenes and verify the sealed archive checksum, but cannot open sealed truth. Exact counts in every sealed scene, zero false positives, false negatives, duplicates, and prohibited-structure hits, CPU execution, and ONNX parity at most `1e-5` remain mandatory. No manifest, production store entry, package, or approval exists. |
