...
| Marker center detection | Line-aware revision v1 P3 selected | Project-owned Apache-2.0 source and new procedural families only; no Chandler, private article, downloaded weights, or prior-candidate bytes | P1 produced no checkpoint. P3 reuses ignored P2 checkpoint SHA-256 `d80732ae317faa3a315fec0d2add194091fe5ce4295be3ff1d6faa65af7562fb` and ONNX SHA-256 `25d79f6f207f35180d7482e147a1fb1fc099dcd15ab098f109cfb3242c7ff144`; both remain unapproved. | P2 passed CPU parity but missed four validation markers. P3 used zero optimizer steps, passed CPU parity at `8.270144462585449e-07`, and produced all 9 exact selection scenes with 63/63 markers, zero false positives, misses, duplicates, or prohibited hits at threshold `0.07`. The public archive remains unopened. | Experimental, public gate authorized | P1 through P3 are consumed. The single truth-hidden public evaluation is authorized exactly once. Even a pass cannot authorize production without an independent artifact-mask gate, adapter, manifest, model store, packaging, and clean-machine evidence. |
