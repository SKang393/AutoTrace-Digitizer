...
| OCR text detection | `PP-OCRv5_mobile_det` official archive candidate | PaddleOCR `v3.5.0` pinned to `33cbdd9deb2e00f61e7966db70669b249c005a37`; exact 4,935,680-byte archive SHA-256 `50446e5d01ac2a73d5319c89513281f6578414c888c602f9af13f93feefffc58`; all three members inventoried | Ignored audit copy only | No Graph Auto Reader conversion, provider, or graph benchmark was run because artifact terms failed first | Candidate, blocked before conversion | The archive contains no artifact-scoped license, commercial-use grant, redistribution grant, or notice. Stop before conversion or approval. |
| OCR text recognition | `en_PP-OCRv5_mobile_rec` official archive candidate | Same pinned source revision; exact 8,007,680-byte archive SHA-256 `e595b4cf2ffad19fbb5a61ba345d63939577a3ab8717b6e5995642590c9101b4`; all three members and embedded dictionary binding inventoried | Ignored audit copy only | No Graph Auto Reader conversion, provider, or graph benchmark was run because artifact terms failed first | Candidate, blocked before conversion | The archive contains no artifact-scoped license, commercial-use grant, redistribution grant, or notice. Stop before conversion or approval. |
