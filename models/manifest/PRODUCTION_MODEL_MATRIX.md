...
| Marker center detection | Candidate-level revision v1 P3 selected for sealed gate | Project-owned Apache-2.0 source and procedural graph scenes only; no Chandler, private article, downloaded weight, or prior-revision candidate reuse | P1 checkpoint is rejected. Selected P3 reuses P2 checkpoint SHA-256 `6c31737a072fca010348091e20ce283a07e15567b122da26029c5e4e7b9793a8` and ONNX SHA-256 `a6a7249d3993e08b83ec4e4bb7b0d7f8a09a14a233e166920610f14f97f80be8`; both remain ignored and unapproved. | P1 failed. P2 produced 8/9 exact validation scenes at threshold `0.7`. Final P3 used zero optimizer steps, unchanged weights, and threshold `0.2`, then passed 9/9 validation scenes with zero false positives, false negatives, duplicates, and prohibited hits. CPU ONNX parity maximum error `1.1920928955078125e-6`; P3 report SHA-256 `bd7ece68d1eb5b254f60bf58b1dc8fc0f648ba507df72a9c3798693c72a591a1`; sealed public evaluations remain zero. | Selected for once-only sealed public gate, not production-approved | All three candidate slots are consumed. The truth-hidden 16-scene archive remains unopened but is authorized once for the exact P3 report and ONNX. Exact counts in every sealed scene, zero false positives, false negatives, duplicates, and prohibited-structure hits remain mandatory. No manifest, production store entry, package, or approval exists. |
