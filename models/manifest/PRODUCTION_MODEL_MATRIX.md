...
| OCR text detection | `PP-OCRv5_mobile_det` official archive candidate | PaddleOCR `v3.5.0` pinned to `33cbdd9deb2e00f61e7966db70669b249c005a37`; exact 4,935,680-byte archive SHA-256 `50446e5d01ac2a73d5319c89513281f6578414c888c602f9af13f93feefffc58`; official `PaddlePaddle/PP-OCRv5_mobile_det@0d63e78e2b680928f6b1747d76a08db6e645efb7` model card scopes Apache-2.0 to three byte-identical payloads | Ignored conversion-only ONNX SHA-256 `d4aa24d408cd70b8b9f66cc758e20f397fc31a9c69d8477cf8887fc53bd5fceb` | Two opset-11 conversions were byte-identical; ONNX full check found no external tensors, and 16 CPU raw-tensor cases across four dynamic shapes passed with maximum difference `1.349323213162279e-07` | Candidate, conversion-only evidence passed | Run the frozen public and sealed exact-count and exclusion gates, review notices, create an approval-false manifest, then pass production approval and packaging discovery. |
| OCR text recognition | `en_PP-OCRv5_mobile_rec` official archive candidate | Same pinned source revision; exact 8,007,680-byte archive SHA-256 `e595b4cf2ffad19fbb5a61ba345d63939577a3ab8717b6e5995642590c9101b4`; official `PaddlePaddle/en_PP-OCRv5_mobile_rec@267c36e24c331595590fe7bd72bde2436fd286f2` model card scopes Apache-2.0 to three byte-identical payloads | Ignored conversion-only ONNX SHA-256 `7839f12b644f574eaf677e92a11bd3e337f4b2f910160666073888783fece743` | Two opset-11 conversions were byte-identical; ONNX full check found no external tensors, and 16 CPU raw-tensor cases across five dynamic widths passed with maximum difference `2.205371856689453e-06` | Candidate, conversion-only evidence passed | Run the frozen public and sealed exact, CER, role, and exclusion gates, review notices, create an approval-false manifest, then pass production approval and packaging discovery. |
