...
| OCR text detection | `PP-OCRv5_mobile_det` official archive candidate | PaddleOCR `v3.5.0` pinned to `33cbdd9deb2e00f61e7966db70669b249c005a37`; exact 4,935,680-byte archive SHA-256 `50446e5d01ac2a73d5319c89513281f6578414c888c602f9af13f93feefffc58`; official `PaddlePaddle/PP-OCRv5_mobile_det@0d63e78e2b680928f6b1747d76a08db6e645efb7` model card scopes Apache-2.0 to three byte-identical payloads; reviewed Apache-2.0/change notice bundle is tracked | Ignored evaluated ONNX SHA-256 `d4aa24d408cd70b8b9f66cc758e20f397fc31a9c69d8477cf8887fc53bd5fceb` | Conversion parity passed at `1.349323213162279e-07`, but the once-only frozen 220-case gate produced detection exact count `18/220`, 195 false regions across text cases, and false regions on 7/20 exclusions | Experimental, failed | The distinct `graph-structure-consensus-v1` evaluator, 500-case protocol, and C# approval gate are now frozen and source-bound before fixture generation. They bind and rederive exact fixture and BGR pixels, mask geometry, model/candidate consensus, truth matches, duplicates, exclusions, tensors, and marker evidence. No new fixture or inference result exists yet. Do not tune or rerun the exposed split. Freeze the new split once, execute the exact CPU composition once, and require independent marker-stage evidence before any manifest, store, or package transition. |
| OCR text recognition | `en_PP-OCRv5_mobile_rec` official archive candidate | Same pinned source revision; exact 8,007,680-byte archive SHA-256 `e595b4cf2ffad19fbb5a61ba345d63939577a3ab8717b6e5995642590c9101b4`; official `PaddlePaddle/en_PP-OCRv5_mobile_rec@267c36e24c331595590fe7bd72bde2436fd286f2` model card scopes Apache-2.0 to three byte-identical payloads; reviewed Apache-2.0/change notice bundle is tracked | Ignored evaluated ONNX SHA-256 `7839f12b644f574eaf677e92a11bd3e337f4b2f910160666073888783fece743` | Conversion parity passed at `2.205371856689453e-06`, but the fixed gate produced validation and sealed exact match `0.0`, CER `1.0`, and role accuracy `0.03` and `0.02` | Experimental, failed | The input, structure-consensus, exact-pixel, and approval evidence contracts are frozen under `graphreader-ocr-structure-consensus-public-gate-v1`. Reconsideration still requires the new one-time frozen split, one passing fixed-metric run, direct CPU fixture provenance, independent marker-stage evidence, model-store discovery, and packaging discovery. The exposed split remains forbidden. |
