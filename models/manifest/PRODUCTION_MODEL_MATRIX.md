...
| Marker center detection | Candidate-level revision v1 P1/P2 failures and P3 preregistration | Project-owned Apache-2.0 source and procedural graph scenes only; no Chandler, private article, downloaded weight, or prior-revision candidate reuse | P1 checkpoint is rejected. P2 checkpoint SHA-256 `6c31737a072fca010348091e20ce283a07e15567b122da26029c5e4e7b9793a8` and ONNX SHA-256 `a6a7249d3993e08b83ec4e4bb7b0d7f8a09a14a233e166920610f14f97f80be8` remain ignored and unapproved. | P1 failed 0/9 exact scenes and ONNX export. P2 passed CPU ONNX parity at `1.1920928955078125e-6`, then produced 8/9 exact validation scenes with zero false positives, duplicates, or prohibited hits and one false negative at threshold `0.7`. P2 report SHA-256 `d4892996554f7dd76e81b524fe7daf4b077035150425cbe1e9ede59f31e7c102`; sealed public evaluations remain zero. One bounded diagnostic found the unchanged payload produces 9/9 exact validation scenes at threshold `0.2`. | P1 and P2 consumed and rejected; P3 preregistered, not executed | P1 and P2 cannot rerun. P3 is the final authorized candidate and changes only the threshold with zero optimizer steps and unchanged weights. The truth-hidden 16-scene archive remains unopened. Exact counts in every sealed scene, zero false positives, false negatives, duplicates, and prohibited-structure hits, CPU execution, and ONNX parity at most `1e-5` remain mandatory. No manifest, production store entry, package, or approval exists. |
