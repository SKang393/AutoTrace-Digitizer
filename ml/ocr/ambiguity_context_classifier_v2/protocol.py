...
"""Frozen protocol for line-relative ambiguity glyph classification."""
...
def protocol_configuration(*, runner_source_bundle_sha256: str) -> dict[str, object]:
    return {
        ...
        "trigger_evidence": {
            "path": "ml/ocr/ambiguity_glyph_classifier_v1/P2_RESULT.json",
            "sha256": "5c8d252a54615382697130494b3fbe114b71cd55d6a194643aa79af65d2f7801",
            "p1_uppercase_o_accuracy": 0.7375, "p2_lowercase_o_accuracy": 0.75625,
        ...
        "generalization_label_included": False, "manifest_created": False, "model_store_promoted": False,
