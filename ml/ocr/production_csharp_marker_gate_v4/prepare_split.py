...
"""Generate and seal the disjoint V4 archive without executing any model."""
...
SOURCE_PATHS = (
    ...
    Path("ml/ocr/production_csharp_marker_gate_v4/protocol.py"),
    Path("ml/ocr/production_csharp_marker_gate_v4/dataset.py"),
    Path("ml/ocr/production_csharp_marker_gate_v4/prepare_split.py"),
    Path("ml/ocr/production_csharp_marker_gate_v4/PROTOCOL.json"),
    ...
    Path("src/GraphReader.Ocr/OcrV8ProductionCompositionFactory.cs"),
    ...
    Path("tests/GraphReader.Integration.Tests/IntegrationSmoke/OcrMarkerDirectPublicGateV4Tests.cs"),
)
