...
def test_p3_public_gate_is_consumed_and_checksum_bound() -> None:
    ...
    assert result["public_gate_report_sha256"] == entry["public_gate_report_sha256"]
...
def test_public_gate_is_frozen_hidden_and_unapproved() -> None:
    ...
    assert _load(ROOT / "P3_RESULT.json")["status"] == "public_gate_passed_unapproved"
