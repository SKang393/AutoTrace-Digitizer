...
"""Frozen identities and mandatory gates for the first direct C# composition."""

from __future__ import annotations


TASK = "ocr-marker-production-composition"
REVISION = "graphreader-csharp-ocr-marker-composition-v1"
COMPOSITION_ID = "production-ocr-to-normalized-marker-composed-v1"
SCENE_COUNT = 40
SCENE_WIDTH = 640
SCENE_HEIGHT = 320
...
RENDERER_FAMILIES = (
    "offset-graph-label-bands-public-a",
    "offset-graph-label-bands-public-b",
    "offset-graph-label-bands-public-c",
    "offset-graph-label-bands-public-d",
    "offset-graph-label-bands-public-e",
)
DEGRADATION_FAMILIES = (
    "asymmetric-luma-ramp-public",
    "cross-axis-scan-public",
    "gamma-quantized-paper-public",
    "corner-falloff-public",
)
...
def protocol_configuration() -> dict[str, object]:
    ...
    return {
        ...
        "state": "frozen_before_any_model_execution_on_the_new_split",
        "models": {
        ...
        "composition": {
            ...
            "marker_runtime": "normalized_marker_proposal_runtime_v1",
