...
"""Final quadratic-lift proposal confirmation calibrator candidate."""
...
class QuadraticProposalConfirmationCalibrator(nn.Module):
    """Small MLP over each frozen feature and its deterministic square."""
...
__all__ = ["QuadraticProposalConfirmationCalibrator"]
