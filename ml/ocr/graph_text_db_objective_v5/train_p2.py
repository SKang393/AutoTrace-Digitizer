...
"""Single-use P2 training with the restored ignored-boundary constraint."""
...
from .candidate_runner_p2 import REPO_ROOT, run_candidate


CANDIDATE_ID = "P2"
CONFIG_PATH = Path("ml/ocr/graph_text_db_objective_v5/training/p2.json")
CANONICAL_OUTPUT = Path("ml/ocr/graph_text_db_objective_v5/artifacts/P2-run")
RUNNER_SOURCE_PATHS = (
    Path("ml/ocr/graph_text_db_objective_v5/candidate_runner_p2.py"),
    Path("ml/ocr/graph_text_db_objective_v5/dataset.py"),
    Path("ml/ocr/graph_text_db_objective_v5/losses.py"),
    Path("ml/ocr/graph_text_db_objective_v5/losses_p2.py"),
    Path("ml/ocr/graph_text_db_objective_v5/model.py"),
    Path("ml/ocr/graph_text_db_objective_v5/protocol.py"),
    Path("ml/ocr/graph_text_db_objective_v5/train_p2.py"),
