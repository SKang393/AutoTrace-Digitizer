...
from .diagnose_p1 import _iou, _median


REPO_ROOT = Path(__file__).resolve().parents[3]
REPORT_PATH = Path("ml/ocr/graph_text_db_objective_v5/artifacts/P2-run/candidate-report.json")
ONNX_PATH = Path("ml/ocr/graph_text_db_objective_v5/artifacts/P2-run/graph-text-db-objective-v5-p2.onnx")
OUTPUT_PATH = Path("ml/ocr/graph_text_db_objective_v5/artifacts/P2-run/selection-diagnosis.json")
EXPECTED_REPORT_SHA256 = "308529719b824374d9a59abee3bc89b6655df7a2a039500658f4be4fb13052b1"
EXPECTED_ONNX_SHA256 = "d799941bce411e00bc401972e4d48e51f46f249308db9181b6cb99fc6dbacea9"
...
def main() -> int:
    ...
    below_iou_confidences: list[float] = []
    ...
    for frame in frames:
        ...
        if best_iou >= 0.5:
            ...
            below_iou_confidences.append(float(best.confidence))
        if len(regions) > 1:
    ...
    diagnosis = {
        ...
        "below_iou_confidence_median": _median(below_iou_confidences),
