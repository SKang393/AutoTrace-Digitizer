...
TASK="ocr-recognition"; REVISION="graph-ambiguity-source-group-v3"; PUBLIC_REVISION=f"{REVISION}-public-v1"; CANDIDATE_ID="P1"; SEED=20261531; IMAGE_SIZE=32
...
def protocol_configuration(*,runner_source_bundle_sha256:str)->dict[str,object]:
    return {"schema":"graphreader.ocr-ambiguity-source-group-protocol.v1","task":TASK,"revision":REVISION,"status":"candidate_1_preregistered",
            ...
            "experiment_budget":3,"currently_preregistered_candidate":CANDIDATE_ID,"consumed_candidates":[],
            ...
            "model_license":"Apache-2.0","classes":list(GLYPHS),"seed":SEED,"split_counts_per_class":COUNTS_PER_CLASS,"gates":GATES,
