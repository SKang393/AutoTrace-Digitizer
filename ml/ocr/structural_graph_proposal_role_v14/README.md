...
The split is now frozen. The training tensor contains 29,518 proposals, including all 3,840 train truths and 25,678 structural-family negatives. The 208-scene truth-hidden public archive SHA-256 is `57d8dbf2435f1cff415a1ef7641db59de0556c416532f11f6790164e3db66ebf`; its truth remains unavailable to the candidate runner and its evaluation limit is one. Exact P1 is authorized by a separate committed ledger checkpoint. P2, P3, and the public gate remain closed.

No V14 candidate has executed yet. No manifest, production model-store entry, package payload, private Chandler automatic run, production approval, or release eligibility exists.
