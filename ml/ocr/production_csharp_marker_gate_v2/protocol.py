...
"""Frozen identities and mandatory gates for the second direct C# composition."""

from __future__ import annotations


TASK = "ocr-marker-production-composition"
REVISION = "graphreader-csharp-ocr-marker-composition-v2"
COMPOSITION_ID = "production-ocr-to-normalized-marker-composed-v2"
SCENE_COUNT = 40
SCENE_WIDTH = 640
SCENE_HEIGHT = 320
...
RENDERER_FAMILIES = (
    "shifted-graph-label-orbits-public-f",
    "shifted-graph-label-orbits-public-g",
    "shifted-graph-label-orbits-public-h",
    "shifted-graph-label-orbits-public-i",
    "shifted-graph-label-orbits-public-j",
)
DEGRADATION_FAMILIES = (
    "diagonal-paper-wave-public",
    "radial-luma-shelf-public",
    "subpixel-tone-steps-public",
    "opposed-edge-falloff-public",
)
