...
"""Generate and seal the disjoint V2 archive without executing any model."""
...
SOURCE_PATHS = (
    ...
    Path("ml/ocr/production_csharp_marker_gate_v2/protocol.py"),
    Path("ml/ocr/production_csharp_marker_gate_v2/dataset.py"),
    Path("ml/ocr/production_csharp_marker_gate_v2/prepare_split.py"),
    Path("ml/ocr/production_csharp_marker_gate_v2/PROTOCOL.json"),
    ...
    Path("tests/GraphReader.Integration.Tests/IntegrationSmoke/OcrMarkerDirectPublicGateV2Tests.cs"),
)
