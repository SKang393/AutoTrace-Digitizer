...
"""Export-safe visual and geometry fusion classifier for OCR V8 proposals."""
...
class ComponentFusionNet(nn.Module):
    """Classify proposals without treating scalar geometry as image columns."""
    ...
    def forward(self, value: torch.Tensor) -> torch.Tensor:
        if value.ndim != 4 or value.shape[1:] != (INPUT_CHANNELS, CROP_HEIGHT, ENCODED_WIDTH):
            raise ValueError("OCR V8 proposal tensor must be [proposal_count,2,32,140]")
