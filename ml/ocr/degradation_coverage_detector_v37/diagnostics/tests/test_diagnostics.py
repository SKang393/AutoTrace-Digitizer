...
"""Focused contract checks for the V37 aggregate diagnostic."""
...
def test_report_is_present_aggregate_only_and_stage_is_actionable() -> None:
    report = json.loads(REPORT.read_text(encoding="utf-8"))
    assert report["schema"] == "graphreader.ocr-degradation-coverage-detector-v37-diagnostic.v1"
    ...
    assert report["fixed_hashes"]["v37_onnx"]["sha256"] == EXPECTED_MODEL_SHA256
    assert report["fixed_hashes"]["v37_checkpoint"]["sha256"] == EXPECTED_CHECKPOINT_SHA256
