...
"""Single-use P3 training for full-resolution input refinement."""
...
from ml.ocr.graph_text_stride4_v4.candidate_runner import REPO_ROOT, run_candidate

from .model_p3 import Stride4FullResolutionRefinementNet
from .protocol import SEED


CANDIDATE_ID = "P3"
CONFIG_PATH = Path("ml/ocr/graph_text_stride4_v4/training/p3.json")
CANONICAL_OUTPUT = Path("ml/ocr/graph_text_stride4_v4/artifacts/P3-run")
RUNNER_SOURCE_PATHS = (
    ...
    Path("ml/ocr/graph_text_stride4_v4/model_p3.py"),
    Path("ml/ocr/graph_text_stride4_v4/protocol.py"),
    Path("ml/ocr/graph_text_stride4_v4/train_p3.py"),
...
def train_candidate(output_dir: Path) -> dict[str, object]:
    return run_candidate(
        ...
        model_factory=lambda: Stride4FullResolutionRefinementNet(seed=SEED),
    )
