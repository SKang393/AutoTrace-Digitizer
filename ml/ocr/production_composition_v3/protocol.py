...
"""Frozen constants for the OCR production-composition V3 gate."""
...
REVISION = "graphreader-v10-official-spacing-p2-numeric-v5-composition-v3"
...
DETECTOR_PUBLIC_REPORT_SHA256 = "1c7526cb2147a7a68cdc6eb3d6bc3a073324b3b08f3c81c8b359832f038de7b1"
...
SPLITS = (
    SplitRegistration(
        ...
        80,
        719_000,
        "five-role-offset-spacing-scenes-composition-v3-validation",
        "bilinear-resample-row-fade-composition-v3-validation",
    ...
    SplitRegistration(
        ...
        112,
        761_000,
        "five-role-mirrored-spacing-scenes-composition-v3-public",
        "contrast-quantization-column-fade-composition-v3-public",
...
def split_registration(split: str) -> SplitRegistration:
    try:
        ...
        raise ValueError(f"Unknown OCR production-composition V3 split: {split}") from error


def protocol_configuration() -> dict[str, object]:
    return {
        "evidence_policy": "ml/policy/evidence-policy.json",
        "schema": "graphreader.ocr-production-composition-protocol.v3",
        "task": TASK,
        "revision": REVISION,
        ...
        "predecessor": {
            ...
            "status": "failed",
            "failure": "one spaced multi-glyph annotation detector false negative across 400 truths",
            "public_archive_opened": False,
            "fixture_bytes_reused": False,
        },
        "models": {
            "detector": {
                "revision": "graph-text-spaced-component-recall-v10-p3",
                "onnx_sha256": DETECTOR_ONNX_SHA256,
                "threshold": DETECTOR_THRESHOLD,
                "public_component_report_sha256": DETECTOR_PUBLIC_REPORT_SHA256,
                "public_component_status": "pass_unapproved",
            },
            "general_recognizer": {
        ...
        "data_scope": (
            ...
            "Generalization, private/article images, external datasets, V10/V2 fixture bytes, or tuning"
        ),
        "synthetic_only": True,
...
__all__ = [
    ...
    "DETECTOR_PUBLIC_REPORT_SHA256", "DETECTOR_THRESHOLD", "EXACT_MATCH_MINIMUM",
    "NUMERIC_EXACT_MINIMUM", "NUMERIC_RECOGNIZER_ONNX_SHA256", "NUMERIC_THRESHOLD",
    "OFFICIAL_INFERENCE_YAML_SHA256", "OFFICIAL_RECOGNIZER_ONNX_SHA256", "PLOT_BOUNDS",
    "PUBLIC_REVISION", "REVISION", "ROLE_ACCURACY_MINIMUM", "SCENE_HEIGHT", "SCENE_WIDTH",
    "SPACING_SOURCE_SHA256", "SPLITS", "TASK", "TRUTH_MATCH_IOU_MINIMUM", "VALIDATION_REVISION",
    "WORD_EXACT_MINIMUM", "protocol_configuration", "split_registration",
]
