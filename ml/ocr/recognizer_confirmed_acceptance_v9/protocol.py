...
"""Frozen P1 identities and gates for OCR acceptance candidate V9."""
...
CANDIDATE_ID = "P1"
COMPOSITION_ID = "graphreader-v10-recognizer-confirmed-acceptance-composition-v9"
SCENE_COUNT = 96
SCENE_WIDTH = 640
SCENE_HEIGHT = 320
PLOT_BOUNDS = (104, 48, 510, 256)
OFFICIAL_MINIMUM_CONFIDENCE = 0.65
RENDERER_FAMILIES = tuple(
    f"recognizer-confirmed-structure-collision-v9-selection-{suffix}"
    for suffix in "abcdefgh"
)
DEGRADATION_FAMILIES = (
    "cross-axis-sinusoid-v9-selection",
    "local-shelf-quantization-v9-selection",
    "asymmetric-paper-fade-v9-selection",
    "row-column-ripple-v9-selection",
)
MODEL_SHA256 = {
...
def configuration() -> dict[str, object]:
    return {
        "schema": "graphreader.ocr-recognizer-confirmed-acceptance-protocol.v1",
        "task": TASK,
        "revision": REVISION,
        "candidate_id": CANDIDATE_ID,
        "composition_id": COMPOSITION_ID,
        "state": "p1_preregistered_before_selection_identity_materialization_or_model_execution",
        "defect_class": (
            "the consumed V4 direct composition found all 320 OCR truths but admitted "
            "192 false regions because the high-confidence detector band did not require "
            "recognizer evidence"
        ),
        "isolated_change": (
            "require official recognizer confidence at or above 0.65 before accepting "
            "a proposal through the unchanged detector >=0.95 band"
        ),
        "experiment_budget": 3,
        "split": {
        ...
        "candidate": {
            "official_minimum_confidence": OFFICIAL_MINIMUM_CONFIDENCE,
            "detector_threshold": 0.95,
            "other_v8_thresholds_unchanged": True,
