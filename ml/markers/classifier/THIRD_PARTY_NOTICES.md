# Marker classifier training toolchain notices
...
These dependencies, wheels, and native libraries are not included in the
Windows application distribution by this training session. The license files
are public and Git eligible. Procedural data and trained weights contain only
original Apache-2.0 project work. No external or pretrained weights are used.
