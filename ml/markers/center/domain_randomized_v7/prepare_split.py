...
"""Materialize and seal the fresh marker-center V7 splits exactly once."""
...
SOURCE_PATHS = (
    ...
    Path("ml/markers/center/domain_randomized_v7/prepare_split.py"),
)
...
def prepare() -> dict[str, object]:
    ...
    if OUTPUT_ROOT.exists() or any(path.exists() for path in tracked_outputs):
        raise RuntimeError("Marker-center V7 splits or seals already exist")
    ...
    public_dataset = {
        "schema": "graphreader.marker-center-domain-randomized-public-dataset.v7",
        "revision": REVISION,
    ...
    public_seal = {
        "schema": "graphreader.marker-center-domain-randomized-public-seal.v7",
        "revision": REVISION,
    ...
    selection = {
        "schema": "graphreader.marker-center-domain-randomized-selection.v7",
        "revision": REVISION,
        "train": {
            **SPLITS["train"],
    ...
    report = {
        "schema": "graphreader.marker-center-domain-randomized-split-freeze.v7",
        "revision": REVISION,
