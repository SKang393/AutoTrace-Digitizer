...
from ml.markers.center.domain_randomized_v7.train_p3 import RUNNER_SOURCE_PATHS, THRESHOLDS
...
def test_protocol_config_and_budget_are_checksum_bound_and_p3_blocked() -> None:
