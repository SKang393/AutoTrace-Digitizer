...
"""Single-use public gate for marker-center runtime-consistency P2."""
...
TASK = "marker-center"
REVISION = "marker-center-runtime-consistency-public-v2-p2"
SPLIT_CONFIG_PATH = Path(
    "ml/markers/center/runtime_consistency_v2/gates/sealed-public-p2.json"
)
...
def evaluate_candidate(
    *,
    ...
    if (
        candidate_report.get("candidate_id") != "P2"
        ...
        or float(candidate_report.get("minimum_center_separation", -1.0))
        != MINIMUM_CENTER_SEPARATION
    ):
        raise RuntimeError(
            "Only the exact zero-training P2 selection winner may open the public gate"
        )
    ...
    try:
        ...
        report: dict[str, object] = {
            "schema": "graphreader.marker-center-runtime-consistency-public-gate-p2.v2",
            "task": TASK,
            "revision": REVISION,
        ...
        failure = {
            "schema": "graphreader.marker-center-runtime-consistency-public-failure-p2.v2",
            "task": TASK,
            "revision": REVISION,
