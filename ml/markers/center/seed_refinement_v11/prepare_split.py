...
"""Materialize fresh V11 splits before any model execution."""
...
from ml.markers.center.seed_refinement_v11.protocol import DESIGN_SOURCE_PATHS, REVISION, ROOT
from ml.markers.gate_seal import canonical_json_bytes, sha256_file, source_bundle_sha256


REPO_ROOT = Path(__file__).resolve().parents[4]
OUTPUT_ROOT = REPO_ROOT / "ml/markers/center/artifacts/seed-refinement-v11/split-freeze-r2"
...
def prepare() -> dict[str, object]:
    ...
    if any(path.exists() for path in tracked_outputs) or OUTPUT_ROOT.exists():
        raise RuntimeError("Marker-center V11 splits or seals already exist")
    ...
    if len(all_hashes) != len(set(all_hashes)):
        raise RuntimeError("Marker-center V11 source bytes overlap across splits")
    summaries = {
    ...
    public_dataset = {
        "schema": "graphreader.marker-center-seed-refinement-public-dataset.v11",
        "revision": REVISION,
    ...
    public_seal = {
        "schema": "graphreader.marker-center-seed-refinement-public-seal.v11",
        "revision": REVISION,
    ...
    selection = {
        "schema": "graphreader.marker-center-seed-refinement-selection.v11",
        "revision": REVISION,
        **{
            name: {
                **SPLITS[name],
    ...
    report = {
        "schema": "graphreader.marker-center-seed-refinement-split-freeze.v11",
        "revision": REVISION,
