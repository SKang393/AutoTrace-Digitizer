...
"""Single-use P1 training and selection for the radial-feature defect class."""
...
CANDIDATE_ID = "P1"
CONFIG_PATH = Path("ml/markers/center/radial_feature_v1/training/p1.json")
RUNNER_SOURCE_PATHS = (
    Path("ml/markers/center/radial_feature_v1/dataset.py"),
    Path("ml/markers/center/radial_feature_v1/model.py"),
    Path("ml/markers/center/radial_feature_v1/train_p1.py"),
...
def train_candidate(output_dir: Path) -> dict[str, object]:
    ...
    try:
        ...
        phase = "export"
        checkpoint_path = output_dir / "marker-center-radial-feature-p1.pt"
        ...
        onnx_path = output_dir / "marker-center-radial-feature-p1.onnx"
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path("ml/markers/center/artifacts/radial-feature-v1/P1-run"))
