...
"""Single-use public gate for marker-center background invariance P1."""
...
from ml.markers.center.background_invariant_v3.dataset import load_sealed_public_archive
...
TASK = "marker-center"
REVISION = "marker-center-background-invariant-public-v3-p1"
...
def evaluate_candidate(
    *,
    ...
    if (
        ...
        raise RuntimeError("Only the exact selected zero-training P1 may open this public gate")
    ...
    try:
        ...
        report: dict[str, object] = {
            "schema": "graphreader.marker-center-background-invariant-public-gate-p1.v3",
            "task": TASK,
            "revision": REVISION,
        ...
        failure = {
            "schema": "graphreader.marker-center-background-invariant-public-failure-p1.v3",
            "task": TASK,
            "revision": REVISION,
