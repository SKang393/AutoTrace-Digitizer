...
"""Single-use P2 training and selection for the line-aware defect class."""
...
from ml.markers.center.line_aware_v1.model_p2 import (
    LineAwareP2ModelConfig,
    LineAwarePatchNetP2,
)
...
from ml.markers.center.line_aware_v1.train_p1 import _canonical_hash, _configure, _export
...
CANDIDATE_ID = "P2"
CONFIG_PATH = Path("ml/markers/center/line_aware_v1/training/p2.json")
RUNNER_SOURCE_PATHS = (
    ...
    Path("ml/markers/center/line_aware_v1/train_p2.py"),
    Path("ml/markers/gate_seal.py"),
    Path("ml/markers/training_budget.py"),
)


def _runner(model: LineAwarePatchNetP2):
...
def train_candidate(output_dir: Path) -> dict[str, object]:
    ...
    try:
        ...
        model = LineAwarePatchNetP2(LineAwareP2ModelConfig(seed=seed))
        ...
        threshold_results = [
            {
                ...
                "metrics": evaluate_scenes(validation_scenes, _runner(model), threshold=float(threshold)),
            }
        ...
        phase = "export"
        checkpoint_path = output_dir / "marker-center-line-aware-p2.pt"
        torch.save(
            {
        ...
        onnx_path = output_dir / "marker-center-line-aware-p2.onnx"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("ml/markers/center/artifacts/line-aware-v1/P2-run"),
    )
