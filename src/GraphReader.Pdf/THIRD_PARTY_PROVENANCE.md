...
| notice path | `packaging/pdfium-source/review/third-party-notices.dependency-mapped.txt`; 16 exact notice sources are checksum-bound to the 15-component target closure |
...
| review status | Dependency/license closure is complete for the exact candidate. Bundling remains BLOCKED until separate runtime-package, clean-machine, and release approval gates pass; runtime loading remains fail closed. |
