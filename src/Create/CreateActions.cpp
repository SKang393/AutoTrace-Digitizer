...
void CreateActions::createDigitize (MainWindow &mw)
{
  ...
  mw.m_actionDigitizeAutoAxis = new QAction (tr ("Auto Axis"), &mw);
  mw.m_actionDigitizeAutoAxis->setStatusTip (tr ("Automatically detect and create axis calibration points."));
  mw.m_actionDigitizeAutoAxis->setWhatsThis (tr ("Auto Axis\n\n"
                                                 "Automatically detects the bottom x-axis and the y-axis, rotates the image "
                                                 "when the x-axis is tilted, and creates three editable axis calibration points."));
  connect (mw.m_actionDigitizeAutoAxis, SIGNAL (triggered ()), &mw, SLOT (slotDigitizeAutoAxis ()));
...
void CreateActions::createHelp (MainWindow &mw)
{
  ...
  mw.m_actionHelpAbout = new QAction(tr ("About AutoTrace Digitizer"), &mw);
  mw.m_actionHelpAbout->setStatusTip (tr ("About the application."));
  mw.m_actionHelpAbout->setWhatsThis (tr ("About AutoTrace Digitizer\n\nAbout the application."));
