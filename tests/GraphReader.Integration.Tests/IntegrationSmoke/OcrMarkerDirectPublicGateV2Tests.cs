...
/// </summary>
[TestClass]
public sealed class OcrMarkerDirectPublicGateV2Tests
{
    private const string RunVariable = "GRAPHREADER_RUN_OCR_MARKER_CSHARP_PUBLIC_V2";
    private const string ArchiveVariable = "GRAPHREADER_OCR_MARKER_PUBLIC_FIXTURES_V2";
    private const string DetectorVariable = "GRAPHREADER_OCR_MARKER_DETECTOR_V2";
    private const string OfficialVariable = "GRAPHREADER_OCR_MARKER_OFFICIAL_V2";
    private const string NumericVariable = "GRAPHREADER_OCR_MARKER_NUMERIC_V2";
    private const string AmbiguityVariable = "GRAPHREADER_OCR_MARKER_AMBIGUITY_V2";
    private const string MarkerVariable = "GRAPHREADER_OCR_MARKER_CENTER_V2";
    private const string YamlVariable = "GRAPHREADER_OCR_MARKER_OFFICIAL_YAML_V2";
    private const string ReportVariable = "GRAPHREADER_OCR_MARKER_CSHARP_REPORT_V2";
    private const string SourceCommitVariable = "GRAPHREADER_OCR_MARKER_SOURCE_COMMIT_V2";
    private const string CompositionId = "production-ocr-to-normalized-marker-composed-v2";
    ...
    private const int ExpectedSceneCount = 40;
    ...
    public async Task NewSealedBytesExecuteOnceThroughCSharpOcrAndMarkerCpuComposition()
    {
        ...
        string sealPath = Path.Combine(
            ...
            "ml",
            "ocr",
            "production_csharp_marker_gate_v2",
        ...
        string cacheRoot = Path.Combine(
            Path.GetTempPath(),
            "GraphReaderOcrMarkerCSharpPublicV2",
        ...
        CancellationToken cancellationToken)
    {
        ...
        Assert.AreEqual("graphreader-csharp-ocr-marker-composition-v2", manifest.Revision);
        ...
        return new DirectGateReport(
            "graphreader.ocr-marker-production-composition-csharp-public-gate.v2",
            CompositionId,
            sourceCommit,
        ...
        ModelIdentity marker)
    {
        ...
        var opened = new
        {
            schema = "graphreader.ocr-marker-production-composition-opened-seal.v2",
        ...
        Exception? exception)
    {
        ...
        var result = new
        {
            schema = "graphreader.ocr-marker-production-composition-result-seal.v2",
