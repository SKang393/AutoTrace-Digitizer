...
/// </summary>
[TestClass]
public sealed class OcrMarkerDirectPublicGateTests
{
    private const string RunVariable = "GRAPHREADER_RUN_OCR_MARKER_CSHARP_PUBLIC";
    private const string ArchiveVariable = "GRAPHREADER_OCR_MARKER_PUBLIC_FIXTURES";
    private const string DetectorVariable = "GRAPHREADER_OCR_MARKER_DETECTOR";
    private const string OfficialVariable = "GRAPHREADER_OCR_MARKER_OFFICIAL";
    private const string NumericVariable = "GRAPHREADER_OCR_MARKER_NUMERIC";
    private const string AmbiguityVariable = "GRAPHREADER_OCR_MARKER_AMBIGUITY";
    private const string MarkerVariable = "GRAPHREADER_OCR_MARKER_CENTER";
    private const string YamlVariable = "GRAPHREADER_OCR_MARKER_OFFICIAL_YAML";
    private const string ReportVariable = "GRAPHREADER_OCR_MARKER_CSHARP_REPORT";
    private const string SourceCommitVariable = "GRAPHREADER_OCR_MARKER_SOURCE_COMMIT";
    private const string CompositionId = "production-ocr-to-normalized-marker-composed-v1";
    ...
    public async Task NewSealedBytesExecuteOnceThroughCSharpOcrAndMarkerCpuComposition()
    {
        ...
        string sealPath = Path.Combine(
            ...
            "ml",
            "ocr",
            "production_csharp_marker_gate_v1",
        ...
        string cacheRoot = Path.Combine(
            Path.GetTempPath(),
            "GraphReaderOcrMarkerCSharpPublic",
        ...
        CancellationToken cancellationToken)
    {
        ...
        Assert.AreEqual("graphreader-csharp-ocr-marker-composition-v1", manifest.Revision);
        ...
        return new DirectGateReport(
            "graphreader.ocr-marker-production-composition-csharp-public-gate.v1",
            CompositionId,
            sourceCommit,
        ...
        ModelIdentity marker)
    {
        ...
        var opened = new
        {
            schema = "graphreader.ocr-marker-production-composition-opened-seal.v1",
        ...
        Exception? exception)
    {
        ...
        var result = new
        {
            schema = "graphreader.ocr-marker-production-composition-result-seal.v1",
