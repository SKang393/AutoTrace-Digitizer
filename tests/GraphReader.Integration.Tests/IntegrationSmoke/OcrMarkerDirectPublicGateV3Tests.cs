...
/// </summary>
[TestClass]
public sealed class OcrMarkerDirectPublicGateV3Tests
{
    private const string RunVariable = "GRAPHREADER_RUN_OCR_MARKER_CSHARP_PUBLIC_V3";
    private const string ArchiveVariable = "GRAPHREADER_OCR_MARKER_PUBLIC_FIXTURES_V3";
    private const string DetectorVariable = "GRAPHREADER_OCR_MARKER_DETECTOR_V3";
    private const string OfficialVariable = "GRAPHREADER_OCR_MARKER_OFFICIAL_V3";
    private const string NumericVariable = "GRAPHREADER_OCR_MARKER_NUMERIC_V3";
    private const string AmbiguityVariable = "GRAPHREADER_OCR_MARKER_AMBIGUITY_V3";
    private const string MarkerVariable = "GRAPHREADER_OCR_MARKER_CENTER_V3";
    private const string YamlVariable = "GRAPHREADER_OCR_MARKER_OFFICIAL_YAML_V3";
    private const string ReportVariable = "GRAPHREADER_OCR_MARKER_CSHARP_REPORT_V3";
    private const string SourceCommitVariable = "GRAPHREADER_OCR_MARKER_SOURCE_COMMIT_V3";
    private const string CompositionId = "production-v11-ocr-to-normalized-marker-composed-v3";
    ...
    private const int ExpectedSceneCount = 48;
    ...
    public async Task NewSealedBytesExecuteOnceThroughCSharpOcrAndMarkerCpuComposition()
    {
        ...
        string sealPath = Path.Combine(
            ...
            "ml",
            "ocr",
            "production_csharp_marker_gate_v3",
        ...
        string cacheRoot = Path.Combine(
            Path.GetTempPath(),
            "GraphReaderOcrMarkerCSharpPublicV3",
        ...
        try
        {
            ...
            OcrV8ProductionCompositionPipeline ocr = OcrV11CandidateCompositionFactory.Create(
                runtime,
                ocrPayloads,
        ...
        CancellationToken cancellationToken)
    {
        ...
        Assert.AreEqual("graphreader-csharp-ocr-marker-composition-v3", manifest.Revision);
        ...
        return new DirectGateReport(
            "graphreader.ocr-marker-production-composition-csharp-public-gate.v3",
            CompositionId,
            sourceCommit,
        ...
        ModelIdentity marker)
    {
        ...
        var opened = new
        {
            schema = "graphreader.ocr-marker-production-composition-opened-seal.v3",
        ...
        Exception? exception)
    {
        ...
        var result = new
        {
            schema = "graphreader.ocr-marker-production-composition-result-seal.v3",
